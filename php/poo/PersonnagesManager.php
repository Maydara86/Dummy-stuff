...
class PersonnagesManager
{
  ...
  {
    $this->_db->exec('DELETE FROM personnages WHERE id = '.$perso->id()) or die (print_r($this->_db->errorInfo()));
  }
  ...
  public function getList()
  {
    ...
    $q = $this->_db->query('SELECT id, nom, forcePerso, degats, niveau, experience FROM personnages ORDER BY id');
